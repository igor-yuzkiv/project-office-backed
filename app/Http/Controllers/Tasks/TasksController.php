...
class TasksController extends Controller
{
    ...
    public function show(ProjectModel $project, TaskModel $task): TaskResource
    {
    ...
    public function store(StoreTaskRequest $request, ProjectModel $project): JsonResponse
    {
    ...
    public function update(UpdateTaskRequest $request, ProjectModel $project, TaskModel $task): TaskResource
    {
    ...
    public function destroy(ProjectModel $project, TaskModel $task): JsonResponse
    {
