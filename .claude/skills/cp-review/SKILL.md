---
name: cp-review
description: Independent review of a diff by someone other than whoever wrote it. Use when the user asks to review recent work, or when material risk, a trust boundary, or a wide integration seam warrants an outside read. Do not trigger merely because a routine change finished. Delegates to the code-reviewer subagent rather than reviewing in this context.
---
