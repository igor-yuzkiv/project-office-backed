...
applies_to: [code]
use_when:
  - acceptance criteria need explicit evidence, manual checks, or project verification has several steps
  - wide work needs evidence for each unit and the integration seam
skip_when:
  - targeted deterministic feedback already covered a small change and was acted on during implementation
