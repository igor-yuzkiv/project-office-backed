...
- **unknown material choice** → onto the decision list with options and a recommendation, or into
  the spec's *must not decide*;
- **unknown fact someone else holds** → into open questions, with the name of who can answer.
...
decisions_needed: [] # material choices, with options and a recommendation where visible
