...
- потрібно підготувати систему layoutes для мого проету
- думаю це має визначатись змінною на рівні маршруту
- і на основі цієї змінної має підтягуватись відповідний копонент 
- поки потрібно 2 layoute default та auth/guest/public
- покищо layous не будуть нчого реалізовувати максимо контейнер і slot 


приклад з іншого проекту App.vue
```
