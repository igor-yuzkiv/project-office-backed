...
* Projects table UI integration:
  ...
  * Sort button and sort popover above Projects table;
...
* Sorting as part of the filtering system backend foundation.
* Changing existing sorting API contract.
* Advanced filter UI.
...
Додати Sort button у toolbar над Projects table та popover для вибору sort field і direction за Zoho Projects reference pattern, без зміни backend sorting contract.
...
* Sort popover reference: `.project_office/design/references/zoho_project_srot_popover_ui_reference.png`.
...
* UI reference для task 005:
  * `.project_office/design/concept/projects_table_page.png` показує приклад Sort button у toolbar над таблицею;
  * `.project_office/design/references/zoho_project_srot_popover_ui_reference.png` показує compact popover pattern для вибору sort field і direction.
