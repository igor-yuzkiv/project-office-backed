...
// Both are view preferences, and both belong to the URL: the tab so the details
// panel can switch it from across the screen, the panel so collapsing it survives
...
<template>
    <div class="min-h-0 flex flex-1">
        <section class="min-w-0 flex flex-1 flex-col overflow-auto">
            ...
            <DocumentBody v-else-if="openedDocument" v-model:tab="activeTab" :document="openedDocument" />
        </section>
