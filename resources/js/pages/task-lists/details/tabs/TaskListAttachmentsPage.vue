...
import { useTaskListAttachmentsQuery } from '@/entities/task-list/queries'
import { useUploadTaskListAttachmentMutation } from '@/entities/task-list/mutations'
...
const { attachments, paginationMeta, isPending } = useTaskListAttachmentsQuery(taskListId, pagination)

const toast = useToast()
const { mutate: uploadAttachment, isPending: isUploading } = useUploadTaskListAttachmentMutation(taskListId)

function upload(file: File) {
    uploadAttachment(
        { file, role: TaskListAttachmentRoles.UPLOAD },
        {
